# Software To Make
1. Central Settings App (w/ daemon?)
2. Media Suite (Build on jellyfin server, Music, Movies, Ebooks)
3. Office Suite (Possibly build on LSN or OnlyOffice or barebones ontop of a yjs backend)
